      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-lg-5 col-md-3 col-sm-3">
               ...
               <img id="img_01" src="{{ asset('img/product/aa.png') }}"  class="card-img active" data-zoom-image="{{ asset('img/product/aa.png') }}"/>
            </div>
            <div class="col-lg-5 col-md-3 col-sm-3">
               <div class="product-text">
                  ...
                  <p class="p-prices">$1299.00</p>
                  <div class="liness"></div>
                 
                  <p class="p-descs"> {{Lang::get('main.lorem2')}}</p>
                  <div class="quantity">
                     <span>{{Lang::get('main.quantity')}}  </span>
                     <button class="b1" onclick=""><i class="fas fa-minus"></i></i></button>
                     <p>1</p>
                     <button class="b2"><i class="fas fa-plus"></i></i></button>
                  </div>
